...
public class SampleController {
   ...
   void testCriteriaBasedRepository() {
        ...
        var catsToProjection = catCriteriaBuilderRepository.findAllToProjection();
        var catsToProjection2 = catCriteriaBuilderRepository.findAllToProjectionWithObjectBuilder();
    }
}